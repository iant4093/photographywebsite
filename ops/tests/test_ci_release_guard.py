    ...
    def test_tracked_intent_exactly_covers_release_code_and_alarm_routing(self):
        ...
        for rule in role_rules:
            ...
            expected_paths = (
                ...
                if rule["logicalId"] in {"RandomPhotoPoolBuilderFunctionRole", "WorkerZipFunctionRole", "GoogleDriveBackupFunctionRole"}
                else ["Policies"]
            )
            self.assertEqual(rule["propertyPaths"], expected_paths)
        ...
        self.assertEqual(
            add_rules,
            {
                ...
                ("ZipArchiveRefreshFunction", "AWS::Lambda::Function"),
                ("ZipArchiveRefreshFunctionRole", "AWS::IAM::Role"),
                ("ZipArchiveRefreshFunctionAlbumsChanged", "AWS::Lambda::EventSourceMapping"),
                ("ZipArchiveRefreshFunctionReconcileArchives", "AWS::Events::Rule"),
                ("ZipArchiveRefreshFunctionReconcileArchivesPermission", "AWS::Lambda::Permission"),
                ("WorkerZipFunctionArchiveJobs", "AWS::Lambda::EventSourceMapping"),
                ("AdminDriveBackupsFunction", "AWS::Lambda::Function"),
                ("AdminDriveBackupsFunctionRole", "AWS::IAM::Role"),
                ("AdminDriveBackupsFunctionManageBackupsPermission", "AWS::Lambda::Permission"),
                ("DriveBackupStateTable", "AWS::DynamoDB::Table"),
                ("GoogleDriveBackupFunctionBackupIntents", "AWS::Lambda::EventSourceMapping"),
