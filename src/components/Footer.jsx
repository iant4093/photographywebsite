    ...
    return (
        <footer className="mt-auto border-t border-warm-border bg-cream-dark/50">
            <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <a
                    href="https://github.com/iant4093/photographywebsite"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm text-warm-gray hover:text-amber-dark transition-colors duration-300 flex items-center gap-1"
                >
