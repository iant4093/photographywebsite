        ...
        <>
            ...
            {open && (
                <AccessibleLightbox
                    ...
                    onClose={close}
                    className="linen-responsive-lightbox linen-qr-lightbox fixed inset-0 z-[1000] bg-charcoal/95 backdrop-blur-md flex flex-col items-center justify-center p-6 animate-fade-in"
                >
                    <button
                        type="button"
                        onClick={close}
