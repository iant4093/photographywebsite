...
const photoData = {
  ...
  images: [
    { id: 'p1', url: 'https://x.test/p1-full', thumbnailUrl: 'https://x.test/p1-thumb', width: 1600, height: 1200, exif: { model: 'Camera', lens: 'Lens', focalLength: '35mm', focalRatio: 'f/4', shutterSpeed: '1/250', iso: 'ISO 200' }, previewSrcSet: [{ width: 640, url: 'https://x.test/640' }, { width: 1280, url: 'https://x.test/1280' }] },
