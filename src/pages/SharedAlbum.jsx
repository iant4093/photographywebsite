        ...
        >
            ...
            {lightboxIndex !== null && images[lightboxIndex] && album.type === 'video' && (
                <AccessibleLightbox
                    ...
                    className="linen-responsive-lightbox linen-video-lightbox fixed inset-0 z-[1000] bg-charcoal/95 backdrop-blur-sm flex flex-col items-center justify-center p-4 md:p-12 animate-fade-in"
                >
